...
CREATE TABLE IF NOT EXISTS `EdgoDB`.`Measurement` (
  ...
  `INTERACTION_DIFF` DECIMAL(20,15) NULL,
  `INTERACTION_SIGNIFICANT` TINYINT(1) NULL,
  `EXPRESSION_WT_ELISA` DECIMAL(20,15) NULL,
  `EXPRESSION_MUT_ELISA` DECIMAL(20,15) NULL,
  `EXPRESSION_RATIO` DECIMAL(20,15) NULL,
...
CREATE TABLE IF NOT EXISTS `EdgoDB`.`SummaryStatistics` (
  `VARIANT_ID` INT NOT NULL,
  `WT_ELISA_AVERAGE` DECIMAL(20,15) NULL,
  `MUT_ELISA_AVERAGE` DECIMAL(20,15) NULL,
  `WT_EXPRESSED` TINYINT(1) NULL,
  `MUT_EXPRESSED` TINYINT(1) NULL,
  `ELISA_RATIO_AVERAGE` DECIMAL(20,15) NULL,
  `ELISA_LOG2_RATIO` DECIMAL(20,15) NULL,
